...
describe('EDITIONS', () => {
    ...
    describe('CRUD', () => {
        ...
        it('should show error when form is saved before required inputs are filled', async () => {
            await Utils.clickWithQuerySelector('#EditEdition_IsPaid');
        ...
        it('should hide error when form is properly filled', async () => {
            ...
            await Utils.triggerValidation('#EditionDisplayName', '#DailyPrice', '#WeeklyPrice', '#MonthlyPrice', '#AnnualPrice');
        ...
        it('should save changes to record when "Save" button is clicked', async () => {
            await Utils.fillInputs({ '#EditionDisplayName': 'changed_name' });
            await Utils.saveForm();
            await Utils.waitForResponse();
        ...
        async function triggerValidation() {
            await fillInputsWithValidValues();
            await Utils.clearInputs('#EditionDisplayName', '#DailyPrice', '#WeeklyPrice', '#MonthlyPrice', '#AnnualPrice');
        }
